...
public class HttpUtil {
   ...
   * @return JSONObject(通过JSONObject.get(key)的方式获取json对象的属性值)
   */
  public static String checkResult(JSONObject jsonObject, String text) {
    ...
    if (null != jsonObject) {
      try {
        ...
        // 获取token失败
        log.error(
          text + " errcode:" + jsonObject.getInt("errcode") + "，errmsg:" + jsonObject.getString("errmsg"));
